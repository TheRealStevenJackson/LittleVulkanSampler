...
void VulkanCommandBuffer::bindDescriptorSets(VulkanPipelineLayout& pipelineLayout, const std::vector<VulkanDescriptorSet*>& descriptorSets, const std::vector<uint32_t>& dynamicOffsets)
{
